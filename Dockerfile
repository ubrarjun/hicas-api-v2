...
# Install system dependencies + Xvfb + Firefox
RUN apt-get update && apt-get install -y \
    wget gnupg curl unzip ca-certificates xvfb \
    firefox-esr \
...
# Install GeckoDriver 0.36.0 manually
...
# Start Xvfb and Gunicorn together
CMD xvfb-run --auto-servernum --server-args='-screen 0 1920x1080x24' gunicorn --bind 0.0.0.0:10000 app:app
